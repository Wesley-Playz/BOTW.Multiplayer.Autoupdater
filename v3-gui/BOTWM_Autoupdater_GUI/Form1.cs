...
namespace BotWMultiplayerUpdaterGUI
{
    public partial class Form1 : Form
    {
        ...
        private readonly List<string> allowedFilesAndFolders = new List<string>
        {
            ...
            "Milk Bar Launcher.deps.json",
            "Milk Bar Launcher.dll",
            "Milk Bar Launcher.dll.config",
            "Milk Bar Launcher.exe",
            "Milk Bar Launcher.pdb",
            "Milk Bar Launcher.runtimeconfig.json",
            "Newtonsoft.Json.dll",
            "Revrs.dll",
            "SarcLibrary.dll",
            "SarcWrapper.dll",
        ...
        {
            // Define the possible executable names
            string[] exeFileNames = { "Breath of the Wild Multiplayer.exe", "Milk Bar Launcher.exe" };

            foreach (string exeFileName in exeFileNames)
            {
                // Combine the current directory with the executable file name
